...
`XPTR`/`XPTRP`. `listings/disasm/postinstall-syspage.asm` names the installed code after
them.
...
`listings/disasm/postinstall-syspage.asm` shows it at its real addresses.
