...
CARRIED_FIXES = [
    ...
    ([';;  Normalise a page and address pair so the address lies within one page and the surplus is in the page number.'],
     [';;  Flatten a page and address pair into one number.  Not the other way about: the window base is discarded and',
      ...
      ";;  a tidied pair.  PAGEFORM is the inverse, and LAB2 at &602B and &6031 does one then the other -- two pairs flattened so that",
...
# base.asm for everything that is true of both.  The machine, the two-page
# model and how to read a line used to be repeated in each half; they are
# said once in base.asm now, which is the file that gets assembled.
PREAMBLE = """\
...
# The part that is true of both halves, and of the file that includes
# them.  It goes at the top of base.asm.
BASE_PREAMBLE = """\
; ---------------------------------------------------------------------
...
def base_preamble():
    """The part of the reading copy's preamble that base.asm carries."""
