...
We'll also refactor the file tree at some point, but for now, the output should go into listings/clean/, and should contain the post-install file (as postinstall-syspage.asm), masterbasic.asm and masterdos.asm.,
