...
ERR_TRK_SCT_ERROR:              EQU  &55
ERR_FORMAT_TRK_LOST:            EQU  &56
...
ERR_DISK_IS_WRITE_PROTECTED:    EQU  &68
...
HKC_COMADENT:                   EQU  &B7                                 ; Hook code 183, raised by EDIT. (see
                                                                         ; HOOK_COMADENT)
HKC_VARSPACE:                   EQU  &B8                                 ; Keep a &500 gap between the program's end and
                                                                         ; the variables while NVARS sits in the top
                                                                         ; &500 of its page, and close it otherwise.
                                                                         ; (see HOOK_VARSPACE)
...
MB_EXPAND_SCREEN_FILE:          EQU  EXPAND_SCREEN_FILE + &4000
