...
SECTOR_FOR_CHANNEL_2:
               ...
               LDIR                            ; 4621 ED B0
               XOR A                           ; 4623 AF
               LD (DCHAN+RPTH),A               ; 4624 32 0E 7C  as a read would have left it
               POP DE                          ; 4627 D1
...
INSTALL_TAIL_INTO_SYSPAGE:
               ...
               LDIR                                      ; 7D70 ED B0
               RET                                       ; 7D72 C9
               DEFB &36,&00,&A7,&C8,&3A,&71              ; 7D73 6.'H:q  in the file, this and the 96 bytes after it --
                                                         ; to &7DD3 -- are MasterBASIC's EDIT stub body, LD (HL),&00 :
                                                         ; AND A : RET Z : LD A,(FLAGX) : RRA : RET C ... JP &012D,
                                                         ; which INSTALL_TAIL_INTO_SYSPAGE carries to &4F13 and the
                                                         ; installer on to MB &7E03, where HOOK_SETUPREGS copies it from
                                                         ; at run time. FIND_ROM_CODE is written over it here at boot,
                                                         ; from &7D79, which is why the listing shows that
